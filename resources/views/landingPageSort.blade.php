...
@section('content')
    ...
    <div class="w-full flex flex-wrap">
        ...
        <main class=" max-w-6xl space-y-7 mt-24 ml-96 w-10/12">
            <!-- Genre -->
            <section
                x-data="{ open:false, colors:['bg-pink-600', 'bg-pink-500', 'bg-indigo-600' , 'bg-indigo-500', 'bg-yellow-600', 'bg-yellow-500', 'bg-red-600', 'bg-red-500', 'bg-green-600', 'bg-green-500', 'bg-blue-600', 'bg-blue-500'] }"
